...
cmds="$cmds $mysql_cmd"' "show slave status\G" | grep "Slave_IO_State\|Master_Host\|Slave_IO_Running\|Slave_SQL_Running\|Last_Err\|Seconds_Behind_Master\|Last_IO_Err\|Last_SQL_Err\|Master_Server_Id\|Master_UUID\|Slave_SQL_Running_State\|Channel_Name"; '
